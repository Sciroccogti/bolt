...
for method in [METHOD_MITHRAL, METHOD_PQ]:
    for ncodebooks in [512,1024]:
        for ncentroids in [16,32,64,128,256]:
            ...
            if not auto_train_change_nbits and not auto_train_change_upcast:
                ...
                if method == METHOD_MITHRAL:
                    if (ncodebooks,ncentroids) in [(512,16),(512,32),(512,64),(512,128),(512,256),(1024,16),(1024,32),(1024,64),(1024,128)]:
                        continue
                    if (ncodebooks,ncentroids) in [(1024,256),(1024,512)]:
                        train_sam_num = 1000
