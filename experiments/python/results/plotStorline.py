'''
@file plotStorline.py
@author Sciroccogti (scirocco_gti@yeah.net)
@brief 
@date 2023-04-20 13:37:32
@modified: 2023-04-20 14:10:55
'''
...
axLoss.set_title(r"$rms=%se^{-9}$时替换 IDFT 后信道估计损失与存储复杂度关系" % rms)
    ...
    try:
        ...
        if match != None:
            ...
            if method.startswith("MAD"):
                ...
                if loss > maxLoss:
                    maxLoss = loss
                comp = complexity(method, ncodebooks, ncentroids) * 16
